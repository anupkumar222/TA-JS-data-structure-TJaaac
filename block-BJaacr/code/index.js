...
for (const person of got.houses[0].people) {
...
for (const person of got.houses[1].people) {
...
for(house of got.houses) {
  sizeOfObject[house.name] = house.people.length;
}
console.log(sizeOfObject);
